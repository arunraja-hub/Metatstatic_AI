...
class NarwhalsConfig(AppConfig):
    ...
    METASTATIC_AI_MODEL_PATH = os.path.join(BASE_DIR, 'narwhals', 'final_model.h5')
    METASTATIC_AI_MODEL_WEIGHTS_PATH = os.path.join(BASE_DIR, 'narwhals', 'final_model_weights.h5')
