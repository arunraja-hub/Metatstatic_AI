...
import {getPathologyImages} from '../../actions/index'
...
class ImageAnalysis extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
          ...
          pathologyImages : this.props.pathologyImages
        };
    }
    
    componentDidMount() {
        this.props.getPathologyImages();
...
ImageAnalysis.defaultProps = {
  images: [
      {
          src: "http://localhost:8000/media/jpg_images/6_Y86rsEn.jpg",
          thumbnail: "http://localhost:8000/media/jpg_images/6_Y86rsEn.jpg",
          thumbnailWidth: 100,
          thumbnailHeight: 100,
          thumbnailCaption: "80%"
      },
...
const mapStateToProps = state => ({
    pathologyImages : state.pathologyImages.pathologyImages
});

export default (connect(mapStateToProps,{ getPathologyImages})(ImageAnalysis));
